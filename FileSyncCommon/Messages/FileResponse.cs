...
namespace FileSyncCommon.Messages
{
    public abstract class FileResponse : Response
    {
        ...
        protected FileResponse(MessageType messageType, int clientId, long requestId, bool latest, string path, Error error) : base(messageType, clientId, requestId, latest, error)
        {
            _path = path;
        }
